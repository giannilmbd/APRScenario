...
#' @param max_cores maximum number of cores to use for parallel processing (default: 2)
#'
...
KL<-function(Sigma_eps,mu_eps,h,plot_=F,max_cores=2){
  ...
  },mc.cores = max_cores) %>% simplify2array()
